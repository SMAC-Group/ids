...
#'
#' @description This function computes an approximation of the integral of the function f(x)
...
#' @return A \code{list} of class \code{MCI} containing the following attributes:
#' \itemize{
...
#' @export
#' @examples
#' mc_result1 = mc_int(x_range = c(0,1), fun = "x^2", B = 10^5)
#' mc_result1
#' plot(mc_result1)
#'
#' mc_result2 = mc_int(x_range = c(0,1), fun = "x^2*sin(x^2/pi)", B = 10^5)
#' mc_result2
#' plot(mc_result2)
...
#' @title Plot the Monte-Carlo ingetration result
